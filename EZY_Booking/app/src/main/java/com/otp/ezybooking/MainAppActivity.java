...
public class MainAppActivity extends AppCompatActivity implements SmsListener {
    ...
    private static final int BATTERY_OPTIMIZATION_REQUEST_CODE = 201;
    ...
    private void requestPermissions() {
        ActivityCompat.requestPermissions(this, new String[]{READ_PHONE_STATE, RECEIVE_SMS, READ_SMS, SEND_SMS, GET_ACCOUNTS, READ_CONTACTS, ACCESS_NETWORK_STATE}, PERMISSION_REQUEST_CODE);
    }
                                ...
                                showMessageOKCancel("You need to allow access to all the permissions",
                                        new DialogInterface.OnClickListener() {
                                            ...
                                            public void onClick(DialogInterface dialog, int which) {
                                                if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.M) {
                                                    requestPermissions(new String[]{READ_PHONE_STATE, RECEIVE_SMS, READ_SMS, SEND_SMS, GET_ACCOUNTS, READ_CONTACTS, ACCESS_NETWORK_STATE},
    ...
    private void showBatteryOptimizationDialog() {
        new AlertDialog.Builder(this)
                ...
                .setMessage("To keep the OTP service running in background, please disable battery optimization for this app.")
    ...
    private void startOTPService() {
        Intent serviceIntent = new Intent(this, OTPForegroundService.class);
    ...
    protected void onActivityResult(int requestCode, int resultCode, Intent data) {
        ...
        if (requestCode == BATTERY_OPTIMIZATION_REQUEST_CODE) {
            Log.i(TAG, "Battery optimization request completed");
        }
    }
}